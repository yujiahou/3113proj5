...
enum EntityType { PLATFORM, PLAYER, ENEMY, BALL  };
enum AIType     { WALKER, GUARD, FLEE     };
...
public:
    ...
    Entity(GLuint texture_id, float speed, float width, float height, EntityType EntityType, glm::vec3 position,glm::vec3 velocity,bool active);
    ~Entity();
    ...
    bool      const get_ball_active() const { return ball_active; }
    ...
    void const set_ball_active(){ball_active = !ball_active;};
